...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  • ${OUTPUT_DIR}reporte_deteccion.txt        - Reporte de texto"
    echo "  • ${OUTPUT_DIR}resultados_completos.json    - Datos completos"
    echo "  • ${OUTPUT_DIR}resumen_estadisticas.json    - Estadísticas"
